...
\usepackage{graphicx} % Listo para compilar con tus imágenes
\usepackage{geometry}
...
El bloque central de conexiones maneja la distribución de energía y las señales PWM hacia los variadores de velocidad.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{CUBE_RECEPTOR.jpeg}
    \caption{Integración del controlador Cube y el receptor Flysky FS-iA10B. Se observa la conexión digital i-BUS en el puerto \texttt{SERVO} del receptor (LED encendido), la alimentación principal ingresando por \texttt{POWER 1} y las conexiones de control de los ESC en el riel \texttt{MAIN OUT}.}
\end{figure}
...
\section[Prevención de Interferencias Electromagnéticas (EMI)]{Prevención de Interferencias \\ Electromagnéticas (EMI)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{motor_air2213.jpeg}
    \caption{Motor Brushless equivalente a 1000KV. Las corrientes en sus bobinas de cobre lo convierten en un fuerte generador de interferencia.}
\end{figure}
